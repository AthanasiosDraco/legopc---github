...
<body class="js">
	...
	<!-- Slider Area -->
	<section class="hero-slider d-none d-lg-block">
		<!-- Single Slider -->
		<div class="single-slider">
			<!--
			<div id="carouselExampleInterval" class="carousel slide d-none d-lg-block" data-bs-ride="carousel" data-bs-touch="true">
