            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="meta_keywords" class="form-control @error('meta_keywords') is-invalid @enderror" placeholder="*/processor/cpu" value="{{ old('meta_keywords') ?? $product->meta_keywords}}">
              ...
              @if ($product->image)
                <img src="{{ asset('assets/uploads/products/'.$product->image) }}" class="img-thumbnail img-fluid mt-2" style="height: 110px;" alt="">
              @endif
              </div>
              </div>  
